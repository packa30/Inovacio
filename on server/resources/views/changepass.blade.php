  ...
  <div class="obsah-strany w-container">
    <div class="w-form">
      <form id="email-form" data-name="Email Form" class="form" method="post" action="{{ route('change_post') }}" enctype='multipart/form-data'>
        ...
        <div class="row-cennik w-row">
        </label><input type="text" name="oldpassword" placeholder="staré heslo">
        </div>
        <div class="row-cennik w-row">
        </label><input type="text" name="newpassword" placeholder="nové heslo">
        </div>
        <div class="row-cennik w-row">
        </label><input type="text" name="newpassword2" placeholder="nové heslo znova">
        </div>
